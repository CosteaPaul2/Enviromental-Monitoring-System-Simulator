    ...
    switch (type) {
      case "success":
        return {
          ...
          gradient:
            "from-success/5 to-success/15 dark:from-success/5 dark:to-success/10",
        };
      case "error":
        return {
          ...
          gradient:
            "from-danger/5 to-danger/15 dark:from-danger/5 dark:to-danger/10",
        };
      case "warning":
        return {
          ...
          gradient:
            "from-warning/5 to-warning/15 dark:from-warning/5 dark:to-warning/10",
        };
      case "info":
        return {
          ...
          gradient:
            "from-primary/5 to-primary/15 dark:from-primary/5 dark:to-primary/10",
        };
      default:
        return {
          ...
          gradient:
            "from-content2/30 to-content2/60 dark:from-content1/20 dark:to-content1/40",
        };
    }
  };
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        `}
        >
          <Icon className="text-lg" icon={iconName} />
        </div>
